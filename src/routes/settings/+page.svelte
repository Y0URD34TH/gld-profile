<script lang="ts">
	...
	function onSaveComplete() {
		console.log("Save completed. Triggering update.");
		fetch('/update') // Adjust this path to match your internal update endpoint
...
<div class="settings">
		...
		<div class="images">
			<div class="pfp-upload">
				...
				<label for="picture" class="custom-file-upload">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="M288 109.3L288 352c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-242.7-73.4 73.4c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l128-128c12.5-12.5 32.8-12.5 45.3 0l128 128c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L288 109.3zM64 352l128 0c0 35.3 28.7 64 64 64s64-28.7 64-64l128 0c35.3 0 64 28.7 64 64l0 32c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64l0-32c0-35.3 28.7-64 64-64zM432 456a24 24 0 1 0 0-48 24 24 0 1 0 0 48z"/></svg>
				</label>
				<input type="file" id="picture" name="picture" accept="image/png, image/jpeg, image/webp" onchange={handlePFPChange} />
			</div>
			...
			<div class="bg-upload">
				...
				<input type="file" id="background" name="background" accept="image/png, image/jpeg, image/webp" onchange={handleBGChange} />
			</div>
		</div>
	...
	<dialog class="delete" bind:this={dialog}>
		<form action="/api/delete-account" method="POST">
			...
			<p>This action is <b>Permanent</b> and <b>Irreversible</b>, you will lose all access to your account and all data associated with it will be <b><u>deleted</u></b>.</p>
